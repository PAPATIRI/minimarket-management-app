...
interface ButtonProps {
  type: 'primary' | 'secondary' | 'danger' | 'outlinePrimary' | 'outlineSecondary' | 'outlineDanger';
  title: string;
  onPress: () => void;
  style?: object;
}
...
const Button: React.FC<ButtonProps> = ({ type, title, onPress, style }) => {
  ...
  return (
    <TouchableOpacity onPress={onPress} style={[styles.button, { backgroundColor, borderColor }, style]}>
